...
public class Pie_Elements extends AppCompatActivity {

    private static final String PREFS_NAME = "FpiePrefs";
    private static final String CHECKBOX_STATE_KEY_1 = "checkboxState1_fpie";
    private static final String CHECKBOX_STATE_KEY_2 = "checkboxState2_fpie";
    private static final String CHECKBOX_STATE_KEY_3 = "checkboxState3_fpie";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pie_elements);
